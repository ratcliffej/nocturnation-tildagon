# Vendored from https://github.com/JASchilz/uQR (MIT licence) - a
# MicroPython port of the `qrcode` library. Used by the NocturNation
# Help screen to render a QR code for the project URL (Epic 6B B9).
# Verbatim except this import shim: newer MicroPython exposes the regex
# module as `re`, older builds as `ure`.
try:
    import ure as re
except ImportError:
    import re
